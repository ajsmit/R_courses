...
Submit a R markdown script and the knitted output for the Integrative Assignment by no later than 8:00 on Wednesday 27 July 2022. Label the script as follows: **`BCB743_<Name>_<Surname>_Integrative_Assignment.Rmd`** and  **`BCB743_<Name>_<Surname>_Integrative_Assignment.html`** (or use MS Word format).
