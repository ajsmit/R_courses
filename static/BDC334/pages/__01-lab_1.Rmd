...
'Pairwise matrices' section below, but the latter does not have
decimals:

![**Figure 0.**](../images/csv_file.png)
...
\*\*BDC334\_<first_name>\_<last_name>\_Assignement_1.xlsx\*\* and
\*\*BDC334\_<first_name>\_<last_name>\_Assignement_1.docx\*\* (the '\<'
