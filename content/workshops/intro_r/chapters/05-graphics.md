...
![The effect of variance (SD) within a temperature time series on the accurate modelling of decadal trends.](/collection/intro_r/chapters/05-graphics_files/all_plt0_no_interp_natural.png){width=80%}

![The (currently) three most infamous marine heatwaves (MHWs) around the world.](/collection/intro_r/chapters/05-graphics_files/deeper-infamous-event-plots-1.png){width=80%}

![Changes in seaweed biodiversity along the South African coastline.](/collection/intro_r/chapters/05-graphics_files/Ecography_figure5a-d.jpg){width=80%}

![Polar plots of monthly temperatures.](/collection/intro_r/chapters/05-graphics_files/insitu_polarPlots_month_v3.2.jpg){width=80%}

![Most appropriate autoregressive correlation coefficients for areas around western boundary current.](/collection/intro_r/chapters/05-graphics_files/mo_coef.jpg){width=80%}

![The bathymetry of South Africa with SSTs from the MUR product.](/collection/intro_r/chapters/05-graphics_files/MUR_bathy_plot_discrete_20090228.jpg){width=80%}

![The power of the detected decadal trend at each coastal temperature collection site given a hypothetical number of months.](/collection/intro_r/chapters/05-graphics_files/sw-fig-7-1.jpg){width=80%}

![An inset map of False Bay.](/collection/intro_r/chapters/05-graphics_files/false_bay_inset_map_labels2.jpg){width=80%}

![The strength of the relationship between each site based on their biodiversity.](/collection/intro_r/chapters/05-graphics_files/PLOS_ONE_Fig4.jpg){width=80%}

![A hierarchical cluster analysis.](/collection/intro_r/chapters/05-graphics_files/hierarchical_clustsig.jpg){width=80%}

![Current velcoties of Western Boundary Currents.](/collection/intro_r/chapters/05-graphics_files/Fig01_AvisoMeanVelocityMean.png){width=80%}
