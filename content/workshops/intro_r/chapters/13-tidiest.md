...
<div class="figure">
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidiest-group-2-1.png" alt="Relationship between depth and mean temperature." width="672" />
<p class="caption">Figure 1: Relationship between depth and mean temperature.</p>
</div>
...
```
R> Error in `filter()`:
R> ! Problem while computing `..1 = site == "Paternoster" | "Oudekraal"`.
R> Caused by error in `site == "Paternoster" | "Oudekraal"`:
R> ! operations are possible only for numeric, logical or complex types
```
...
<div class="figure">
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidyiest-ggplot-1.png" alt="Line and ribbon plots for the climatologies of several sites." width="672" />
<p class="caption">Figure 2: Line and ribbon plots for the climatologies of several sites.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidiest-n-1-1.png" alt="Dot plot showing range of mean temperatures for the time series in the SACTN dataset." width="672" />
<p class="caption">Figure 3: Dot plot showing range of mean temperatures for the time series in the SACTN dataset.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidiest-n-2-1.png" alt="Dot plot showing range of mean temperatures for the time series in the SACTN dataset with the size of each dote showing the number of occurences of each mean." width="672" />
<p class="caption">Figure 4: Dot plot showing range of mean temperatures for the time series in the SACTN dataset with the size of each dote showing the number of occurences of each mean.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidiest-n-3-1.png" alt="Frequency distribution of mean temperature for each time series in the SACTN dataset." width="672" />
<p class="caption">Figure 5: Frequency distribution of mean temperature for each time series in the SACTN dataset.</p>
</div>
...
```r
read_csv("../../../../static/data/SACTN_data.csv") %>%
  mutate(month = month(date)) %>%
  group_by(site, month) %>%
  summarise(mean_temp = mean(temp, na.rm = TRUE),
            sd_temp = sd(temp, na.rm = TRUE)) %>%
...
<img src="/workshops/intro_r/chapters/13-tidiest_files/figure-html/tidiest-new-age-1.png" width="672" />
