...
![Today's goal.](/collection/intro_r/chapters/08-mapping_files/map_complete.png){width=80%}
...
# Load data
load("../../../../static/data/south_africa_coast.Rdata")
load("../../../../static/data/sa_provinces.RData")
load("../../../../static/data/rast_annual.Rdata")
load("../../../../static/data/MUR.Rdata")
load("../../../../static/data/MUR_low_res.RData")
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-point-1-1.png" alt="Dot plot of chicken weight data." width="672" />
<p class="caption">Figure 1: Dot plot of chicken weight data.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-point-2-1.png" alt="Dot plot off South African coast." width="672" />
<p class="caption">Figure 2: Dot plot off South African coast.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-polygon-1.png" alt="The map of South Africa. Now with province borders!" width="672" />
<p class="caption">Figure 3: The map of South Africa. Now with province borders!</p>
</div>

## Borders

The first thing we will add is the province borders as seen in Figure <a href="#fig:map-goal"><strong>??</strong></a>. Notice how we only add one more line of code to do this.
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-province-1.png" alt="The map of South Africa. Now with province borders!" width="672" />
<p class="caption">Figure 4: The map of South Africa. Now with province borders!</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-expand-1.png" alt="The map, but with the extra bits snipped off." width="672" />
<p class="caption">Figure 5: The map, but with the extra bits snipped off.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-MUR-1.png" alt="Ocean temperature (°C) visualised as an ice cream spill." width="672" />
<p class="caption">Figure 6: Ocean temperature (°C) visualised as an ice cream spill.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-colour-1.png" alt="Ocean temperatures (°C) around South Africa." width="672" />
<p class="caption">Figure 7: Ocean temperatures (°C) around South Africa.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-raster-1.png" alt="Map of South Africa showing *in situ* temeperatures (°C) as pixels along the coast." width="672" />
<p class="caption">Figure 8: Map of South Africa showing *in situ* temeperatures (°C) as pixels along the coast.</p>
</div>
...
<div class="figure">
<img src="/workshops/intro_r/chapters/08-mapping_files/figure-html/map-final-1.png" alt="The cleaned up map of South Africa. Resplendent with coastal and ocean temperatures (°C)." width="672" />
<p class="caption">Figure 9: The cleaned up map of South Africa. Resplendent with coastal and ocean temperatures (°C).</p>
</div>
