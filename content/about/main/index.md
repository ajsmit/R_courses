...
intro: |
  ...
  The next instalment is **Biostatistics**. Here we emphasise the various classes of data, distributions, hypothesis tests, and some basic inferential statistics. We draw in the learnings of Intro R as we manipulate our data and make various visualisations in support of the hypotheses being tested.
